...
for CordicUnit=0:Nfft/2-1
    ...
    fprintf(arquivo,'\t\telsif(Adress''event and Adress = ''0'') then\n\t\t\tCounter := Counter + 1;\n\n\t\tend if;\n\n\tend process;\n\nend Behavioral;');
    fclose(arquivo);
