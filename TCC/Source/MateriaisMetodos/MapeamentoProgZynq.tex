...
\begin{figure}[H]
	...
	\includegraphics[width=1\linewidth]{Images/MateriaisMetodos/FFT16pImplementacaoA.JPG}
...
A partir deste novo bloco é preciso incluir uma IP \textit{ZYNQ7 Process System}, o qual representa o ambiente PS, juntamente com um IP AXI da FFT, criada na Seção (\ref{sec:AXI}), e também uma unidade de controle de Interrupções ($axi_int$).

\vspace{6mm}
\begin{figure}[H]
	\centering
	\captionsetup{width=1\textwidth, font=footnotesize, textfont=bf}	
	\includegraphics[width=1\linewidth]{Images/MateriaisMetodos/FFT16pImplementacaoB.JPG}
	\caption{Criação de um Novo Bloco de Design}
	\vspace{-3.5mm}
	\caption*{Fonte: Vivado HLx 2017.4}
...
\begin{figure}[H]
	\centering
	\captionsetup{width=1\textwidth, font=footnotesize, textfont=bf}	
	\includegraphics[width=1\linewidth]{Images/MateriaisMetodos/FFT16pImplementacaoC.JPG}
...
\begin{figure}[H]
	\centering
	\captionsetup{width=1\textwidth, font=footnotesize, textfont=bf}	
	\includegraphics[width=1\linewidth]{Images/MateriaisMetodos/FFT16pImplementacaoD.JPG}
