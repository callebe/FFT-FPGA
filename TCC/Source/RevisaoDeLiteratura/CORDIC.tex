...
Assim $H_r \cdot W_{N_0}^r$ é equivalente a operação trigonométrica de rotacionar o vetor complexo $H_r$ pelo ângulo de $2\pi r/N_0$. Como pode ser visto abaixo:
...
\lstset{style=VHDL}
	\begin{lstlisting}[mathescape]
		...
		$\displaystyle END$
	\end{lstlisting}
	%\captionof{lstlisting}{Pseudocódigo Algoritmo TBS}
	%\vspace{-3.5mm}
	%\captionof*{lstlisting}{Fonte : \citeonline{Cheng}}
	\label{code:PCTBS}
\vspace{3mm}


Em \citeonline{Cheng} o autor utiliza um exemplo base para explicar o algoritmo TBS, o qual também será usado aqui. Para este exemplo, o ângulo de rotação $\theta$ será $pi/3$, o número máximo de interações será $N=4$ e a resolução de $\theta$ será de $W=~4$ bits. 
