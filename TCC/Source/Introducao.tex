...
A FPGA e uma boa escolha para a implementação do algoritmo da FFT devido a grande variedade de recursos de \textit{hardware}  sintetizáveis, além de possuir recursos de programação paralela que permite o processamento paralelo de sinais, conferindo assim uma maior rapidez na execução do algoritmo. Portanto implementar a FFT, uma ferramenta tao útil em diversas áreas da ciência, em uma plataforma vantajosa como a FPGA, é o principal motivador deste trabalho \cite{kamal}.